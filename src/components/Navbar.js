  ...
  return (
    <section className="py-4 px-10 lg:bg-secondary w-full max-md:px-8 max-lg:flex max-lg:flex-col max-lg:gap-6 max-lg:bg-dark max-sm:py-0 max-sm:pt-4">
      <nav className="flex items-center justify-between max-md:gap-6">
        ...
        >
          <img src={Logo} alt="GameZone" className="w-9 max-sm:w-10" />
          <h2 className="font-bold text-3xl text-light tracking-wide max-sm:hidden">
            <span className="text-primary">Game</span>Zone
          </h2>
        </Link>
        <div className="w-1/4 max-lg:w-2/5 max-md:w-1/2 max-lg:flex max-lg:gap-x-4 max-lg:items-center max-sm:w-11/12 max-sm:gap-x-2">
          <div className="text-light w-4/5 flex bg-transparent outline hover:outline-primary hover:text-primary items-center gap-2 px-3 rounded-xl max-lg:w-full max-lg:h-9 max-sm:h-8 max-sm:px-2">
